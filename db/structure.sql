...
--
-- Name: building_id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: building_prime; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY buildings
    ADD CONSTRAINT building_prime PRIMARY KEY (building_id);
...
INSERT INTO schema_migrations (version) VALUES ('20141015221640');
